...
import io.inst.javassist.bytecode.BytecodeTest;
...
import io.inst.javassist.bytecode.InsertGap0;
import io.inst.javassist.bytecode.MethodInfo;
import io.inst.javassist.bytecode.SignatureAttributeTest;
import io.inst.javassist.bytecode.StackMapTest;
import io.inst.javassist.compiler.CompTest;
import io.inst.javassist.expr.Cast;
...
import io.inst.javassist.expr.Handler;
import io.inst.javassist.expr.Instanceof;
import io.inst.javassist.expr.MethodCall;
import io.inst.javassist.expr.NewExpr;
import io.inst.javassist.proxyfactory.ProxyFactoryTest;
import io.inst.javassist.proxyfactory.Tester;
import io.inst.javassist.runtime.Desc;
import io.inst.javassist.tools.CallbackTest;
import io.inst.javassist.tools.reflect.LoaderTest;
...
public class JvstTest extends JvstTestRoot {
    ...
    public void testLoader() throws Exception {
        ...
        assertEquals(loader.loadClass("test1.Cflow").getClassLoader(),
                     loader.getParent());
        assertEquals(loader.loadClass("io.inst.javassist.Loader").getClassLoader(),
                     loader.getParent());
        assertEquals(loader.loadClass("io.inst.javassist.CtClass").getClassLoader(),
                     loader);
    }
    ...
    public static Test suite() {
        ...
        suite.addTestSuite(HotswapTest.class);
        ...
        suite.addTestSuite(SignatureAttributeTest.class);
        return suite;
    }
}
