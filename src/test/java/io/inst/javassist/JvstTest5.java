...
public class JvstTest5 extends JvstTestRoot {
    ...
    public void testJIRA256() throws Exception {
        ...
        io.inst.javassist.bytecode.annotation.Annotation entityAnno
            = new io.inst.javassist.bytecode.annotation.Annotation("test5.Entity", constpool);
            // = new javassist.bytecode.annotation.Annotation(constpool, ec);

        entityAnno.addMemberValue("value", new ArrayMemberValue(constpool));
