...
import io.inst.javassist.Loader;
...
public class ArrayAccessReplaceTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        simple = (SimpleInterface)new Loader.Simple().invokeDefineClass(simpleClass)
    ...
    public void testComplex() throws Exception {
        ...
        ComplexInterface instance
            = (ComplexInterface)new Loader.Simple().invokeDefineClass(clazz)
                                                             .getConstructor().newInstance();
